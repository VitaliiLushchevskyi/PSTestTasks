    ...
    public class WeatherManagerTests
    {
        ...
        public async Task CompareWeather_ReturnsCorrectComparison()
        {
            ...
            var mockResponses = new Dictionary<string, string>
            {
                ...
                { $"https://api.openweathermap.org/data/3.0/onecall/timemachine?lat=40.7128&lon=-74.0061&dt={todayMiddayUtc}&appid=0eeec1eb1f8d17fa7af099784c36c2f1", "{\"data\":[{\"temp\":20.5,\"rain\":1.2}]}" },
                { $"https://api.openweathermap.org/data/3.0/onecall/timemachine?lat=34.0522&lon=-118.2437&dt={todayMiddayUtc}&appid=0eeec1eb1f8d17fa7af099784c36c2f1", "{\"data\":[{\"temp\":22.1,\"rain\":0.0}]}" }
            };
